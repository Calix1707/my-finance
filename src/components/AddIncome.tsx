  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (insertError) {
        ...
        setError("Ocurrió un error al guardar el ingreso.");
        return;
      }
      ...
      console.log("Resultado de la actualización del saldo:", {
        updateError,
        newBalance,
      });
      ...
      <form onSubmit={handleSubmit} className={styles.incomeForm}>
        ...
        <div className={styles.formGroup}>
          ...
          <div className={styles.categoryIcons}>
            <button type="button" onClick={() => setCategory("Salario")}>
              💰
            </button>
            <button type="button" onClick={() => setCategory("Inversiones")}>
              📈
            </button>
            <button type="button" onClick={() => setCategory("Regalos")}>
              🎁
            </button>
            <button type="button" onClick={() => setCategory("Otros")}>
              ✨
            </button>
            <input
              type="text"
